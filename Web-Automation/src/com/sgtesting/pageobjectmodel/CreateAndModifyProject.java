...
public class CreateAndModifyProject {
	...
	private static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(1000);
			oPage.getProjectDescmodify().clear();
			Thread.sleep(1000);
			oPage.getProjectDescmodify().sendKeys("Customer is a very important person in the IT Industry, Customer is God");
			Thread.sleep(1000);
