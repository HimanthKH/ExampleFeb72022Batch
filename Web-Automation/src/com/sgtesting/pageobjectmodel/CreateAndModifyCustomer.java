...
public class CreateAndModifyCustomer {
	...
	private static void modifyCustomer()
	{
		try
		{
			oPage.getCustomersettingsexisting().click();
			Thread.sleep(1000);
			oPage.getCustomerDescModify().clear();
			Thread.sleep(1000);
			oPage.getCustomerDescModify().sendKeys("Customer is God");
			Thread.sleep(1000);
			oPage.getCustomerclose().click();
			Thread.sleep(1000);
		}catch(Exception e)
		{
			e.printStackTrace();
